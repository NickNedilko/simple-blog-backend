...
import { createPost, getAllPosts, getLastTags, getOnePost, removePost, updatePost,  uploadPostImage } from "../../controllers/post.js";
...
router.post('/:id', authenticate, upload.single('imageUrl'), ctrlWrapper(uploadPostImage));
